...
namespace Biblioteca
{
    internal static class Hardcodeo
    {
        ...
        public static void InicializarPasajeros(List<Pasajero> pasajeros, Dictionary<int, Empleado> empleados)
        {
        ...
        public static void InicializarVuelos(List<Avion> aviones, List<Vuelo> vuelos, List<Pasajero> pasajeros)
        {
            ...
            vuelos.Add(new Vuelo("MLD342", aviones[2].Matricula,false,EDestinos.BuenosAires,EDestinos.Acapulco,new DateTime(2022, 10, 26, 11, 30, 0), new DateTime(2022, 10, 26, 19, 30, 0), 8, false,CargarPasajerosAUnVuelo(pasajeros, false, 8), 0, 0, 0, "Lleno", 0));
            vuelos.Add(new Vuelo("PLA241", aviones[0].Matricula,false,EDestinos.Acapulco,EDestinos.BuenosAires,new DateTime(2022, 11, 3, 5, 30, 0), new DateTime(2022, 11, 3, 17, 30, 0), 12, true,CargarPasajerosAUnVuelo(pasajeros, false, 12), 39, 10, 29, "Disponible",1045));
            vuelos.Add(new Vuelo("HKF352", aviones[5].Matricula,false, EDestinos.Recife,EDestinos.BuenosAires,new DateTime(2022, 10, 10, 18, 0, 0), new DateTime(2022, 10, 11, 5, 0, 0), 11, true, CargarPasajerosAUnVuelo(pasajeros, false, 11), 20, 9, 11, "Disponible", 527));
        ...
        private static List<Pasajero> CargarPasajerosAUnVuelo(List<Pasajero> pasajeros, bool esNacional, int duracion)
        {
            ...
            int index = rnd.Next(0, pasajeros.Count()-20);
            List<Pasajero> lista = new List<Pasajero>();
            lista = pasajeros.GetRange(index, rnd.Next(19, pasajeros.Count() - index));
        ...
        public static void InicializarHistorialVuelos(List<Vuelo> vuelos, List<Avion> aviones, List<Pasajero> pasajeros)
        {
