...
namespace Biblioteca
{
    public static class Hardcodeo
    {
        ...
        public static List<Vuelo> InicializarVuelos(List<Avion> aviones, List<Vuelo> vuelos, List<Pasajero> pasajeros)
        {
            ...
            vuelos.Add(new Vuelo("LPI202", aviones[6].Matricula,true,Destinos.Posadas,Destinos.PuertoMadryn,new DateTime(2022, 12, 28, 17, 15, 0), new DateTime(2022, 12, 28, 21, 15, 0), 4, false, pasajeros, 27));
            ...
            vuelos.Add(new Vuelo("CHT261", aviones[6].Matricula,true,Destinos.Corrientes,Destinos.SantiagoDelEstero,new DateTime(2022, 11, 22, 13, 0, 0), new DateTime(2022, 11, 22, 15, 0, 0), 2, false, pasajeros, 9));
