...
namespace Biblioteca
{
    public static class Hardcodeo
    {
        ...
        {
            vuelos.Add(new Vuelo(aviones[0].Matricula,false,Destinos.BuenosAires,Destinos.Roma,new DateTime(2022,10,4,19,30,0), new DateTime(2022, 10, 5, 5, 30, 0), 10, true,pasajeros,0));
            vuelos.Add(new Vuelo(aviones[0].Matricula,false,Destinos.BuenosAires,Destinos.Miami,new DateTime(2023,1,3,11,30,0), new DateTime(2023, 1, 3, 23, 30, 0), 12, true,pasajeros,59));
            vuelos.Add(new Vuelo(aviones[5].Matricula,true,Destinos.Mendoza,Destinos.Bariloche,new DateTime(2022,10,4,18,0,0), new DateTime(2022, 10, 4, 20, 0, 0), 2, false, pasajeros,17));
            vuelos.Add(new Vuelo(aviones[3].Matricula,true,Destinos.Córdoba,Destinos.Posadas,new DateTime(2022,12,13,4,0,0), new DateTime(2022, 12, 13, 7, 0, 0), 3, false, pasajeros,6));
            vuelos.Add(new Vuelo(aviones[6].Matricula,true,Destinos.Posadas,Destinos.PuertoMadryn,new DateTime(2022,10,4,17,15,0), new DateTime(2022, 10, 4, 21, 15, 0), 4, false, pasajeros, 27));
            vuelos.Add(new Vuelo(aviones[5].Matricula,true,Destinos.Jujuy,Destinos.Ushuaia,new DateTime(2023,3,4,23,45,0), new DateTime(2023, 3, 5, 3, 45, 0), 4, true, pasajeros, 80));
            vuelos.Add(new Vuelo(aviones[6].Matricula,true,Destinos.Corrientes,Destinos.SantiagoDelEstero,new DateTime(2022,11,22,13,0,0), new DateTime(2022, 10, 4, 15, 0, 0), 2, false, pasajeros, 9));
