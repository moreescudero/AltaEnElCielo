...
namespace Biblioteca
{
    public static class Hardcodeo
    {
        ...
        public static List<Vuelo> InicializarVuelos(List<Avion> aviones, List<Vuelo> vuelos, List<Pasajero> pasajeros)
        {
            ...
            vuelos.Add(new Vuelo("LPI202", aviones[6].Matricula,true,Destinos.Posadas,Destinos.PuertoMadryn,new DateTime(2022, 12, 28, 17, 15, 0), new DateTime(2022, 12, 28, 21, 15, 0), 4, false, CargarPasajerosAUnVuelo(pasajeros, false, true, 4), 27, 15, 12, "Disponible"));
            vuelos.Add(new Vuelo("TBY015", aviones[5].Matricula,true,Destinos.Jujuy,Destinos.Ushuaia,new DateTime(2023, 3, 4, 23, 45, 0), new DateTime(2023, 3, 5, 3, 45, 0), 4, true, CargarPasajerosAUnVuelo(pasajeros, true, true, 4), 80, 39, 41, "Disponible"));
            vuelos.Add(new Vuelo("CHT261", aviones[6].Matricula,true,Destinos.Corrientes,Destinos.SantiagoDelEstero,new DateTime(2022, 11, 22, 13, 0, 0), new DateTime(2022, 11, 22, 15, 0, 0), 2, false, CargarPasajerosAUnVuelo(pasajeros, false, true, 2), 9, 9, 0, "Disponible"));
        ...
        {
            vuelos.Add(new Vuelo("PDR928", aviones[4].Matricula, true, Destinos.Corrientes, Destinos.Bariloche, new DateTime(2021, 6, 15, 13, 30, 0), new DateTime(2021, 6, 15, 17, 30, 0), 4, true, CargarPasajerosAUnVuelo(pasajeros, true, true, 4), 3, 0, 3, "Finalizado"));
            vuelos.Add(new Vuelo("GSL348", aviones[2].Matricula, true, Destinos.Mendoza, Destinos.Salta, new DateTime(2022, 2, 26, 18, 0, 0), new DateTime(2022, 2, 26, 21, 0, 0), 3, true, CargarPasajerosAUnVuelo(pasajeros, true, true, 3), 10, 4, 6, "Finalizado"));
            vuelos.Add(new Vuelo("AOS153", aviones[3].Matricula, false, Destinos.BuenosAires, Destinos.Recife, new DateTime(2022, 5, 20, 10, 0, 0), new DateTime(2022, 5, 20, 18, 0, 0), 8, true, CargarPasajerosAUnVuelo(pasajeros, true, false, 8), 12, 2, 10, "Finalizado"));
            vuelos.Add(new Vuelo("WUQ012", aviones[3].Matricula, true, Destinos.Ushuaia, Destinos.PuertoMadryn, new DateTime(2022, 3, 4, 23, 30, 0), new DateTime(2022, 3, 5, 2, 30, 0), 3, false, CargarPasajerosAUnVuelo(pasajeros, false, true, 3), 4, 1, 3, "Finalizado"));
            vuelos.Add(new Vuelo("MVN479", aviones[5].Matricula, true, Destinos.Iguazú, Destinos.Córdoba, new DateTime(2021, 9, 19, 0, 30, 0), new DateTime(2021, 9, 19, 2, 30, 0), 2, false, CargarPasajerosAUnVuelo(pasajeros, false, true, 2), 9, 0, 9, "Finalizado"));
            vuelos.Add(new Vuelo("USJ463", aviones[1].Matricula, false, Destinos.Roma, Destinos.Recife, new DateTime(2022, 7, 20, 16, 45, 0), new DateTime(2022, 7, 21, 4, 45, 0), 12, true, CargarPasajerosAUnVuelo(pasajeros, true, false, 12), 8, 1, 7, "Finalizado"));
            vuelos.Add(new Vuelo("DSI663", aviones[0].Matricula, false, Destinos.BuenosAires, Destinos.Acapulco, new DateTime(2022, 4, 17, 8, 30 , 0), new DateTime(2022, 4, 17, 12, 30, 0), 4, true, CargarPasajerosAUnVuelo(pasajeros, true, true, 4), 0, 0, 0, "Finalizado"));
            vuelos.Add(new Vuelo("NCU671", aviones[4].Matricula, true, Destinos.Córdoba, Destinos.Trelew, new DateTime(2021, 12, 23, 10, 15, 0), new DateTime(2021, 12, 23, 14, 15, 0), 4, false, CargarPasajerosAUnVuelo(pasajeros, false, true, 4), 0, 0, 0, "Finalizado"));
            vuelos.Add(new Vuelo("KAS342", aviones[0].Matricula, false, Destinos.BuenosAires, Destinos.Miami, new DateTime(2021, 11, 30, 17, 0, 0), new DateTime(2021, 12, 1, 3, 0, 0), 10, true, CargarPasajerosAUnVuelo(pasajeros, true, false, 10), 4, 0, 4, "Finalizado"));
            vuelos.Add(new Vuelo("UJW333", aviones[6].Matricula, true, Destinos.SantaRosa, Destinos.Jujuy, new DateTime(2022, 8, 13, 19, 0, 0), new DateTime(2022, 8, 13, 23, 0, 0), 3, false, CargarPasajerosAUnVuelo(pasajeros, false, true, 3), 2, 0, 2, "Finalizado"));
            vuelos.Add(new Vuelo("MKV844", aviones[2].Matricula, true, Destinos.PuertoMadryn, Destinos.Posadas, new DateTime(2021, 8, 30, 5, 30, 0), new DateTime(2021, 8, 30, 7, 30, 0), 2, false, CargarPasajerosAUnVuelo(pasajeros, false, true, 2), 0, 0, 0, "Finalizado"));
            vuelos.Add(new Vuelo("DSO023", aviones[4].Matricula, false, Destinos.Roma, Destinos.Miami, new DateTime(2022, 1, 20, 16, 0, 0), new DateTime(2022, 1, 21, 3, 0, 0), 11, true, CargarPasajerosAUnVuelo(pasajeros, true, false, 11), 0, 0, 0, "Finalizado"));
